...
try:
    exe_path = os.path.join(tool_path, "Your.Tool-Obfuscator-Tool.exe")
    
    if os.path.exists(exe_path):
        print(f"\n{BEFORE + current_time_hour() + AFTER} {INFO} Démarrage de l'outil d'obfuscation Python...")
            ...
            if is_admin():
                ...
                try:
                    ...
                    with open(bat_path, "w") as bat_file:
                        ...
                        bat_file.write(f'echo Lancement de l\'obfuscateur avec privilèges administrateur...\n')
        ...
        print(f"\n{BEFORE + current_time_hour() + AFTER} {INFO} Assurez-vous que le fichier 'Your.Tool-Obfuscator-Tool.exe' est dans le répertoire principal.")
        input(f"{BEFORE + current_time_hour() + AFTER} {INFO} Press to continue -> " + reset)
        Reset()
except Exception as e:
    Error(e)
